...
class SkeletonBuilder_UI():
	...
	self.widgets["publishUIForm"] = cmds.formLayout(w = 300, h = 310, parent = self.widgets["publishUIMainLayout"])
	...
	self.widgets["publishUI_textScrollList"] = cmds.textScrollList(w = 275, h = 150, ams = False, selectCommand = self.updateCharacterNameField, ann = "List of existing characters in the selected project.")
	...
	cmds.formLayout(self.widgets["publishUIForm"], edit = True, af = [(self.widgets["publishUICharNameLabel"], "left", 10), (self.widgets["publishUICharNameLabel"], "top", 230)])
	cmds.formLayout(self.widgets["publishUIForm"], edit = True, af = [(self.widgets["publishUICharNameTF"], "right", 10), (self.widgets["publishUICharNameTF"], "top", 255)])
	
	cmds.formLayout(self.widgets["publishUIForm"], edit = True, af = [(self.widgets["publishUIAdvancedFrame"], "left", 10), (self.widgets["publishUIAdvancedFrame"], "top", 290)])
	...
	cmds.window(self.widgets["publishUIWindow"], edit = True, h =310)
	cmds.columnLayout(self.widgets["publishUIMainLayout"], edit = True, h =310)
	cmds.formLayout(self.widgets["publishUIForm"], edit = True, h =310)
	...
	cmds.window(self.widgets["publishUIWindow"], edit = True, h =550)
	cmds.columnLayout(self.widgets["publishUIMainLayout"], edit = True, h =550)
	cmds.formLayout(self.widgets["publishUIForm"], edit = True, h =550)	
	...
	if cmds.objExists("upperarm_mover_offset_l.pinned"):
		...
		constraint = cmds.aimConstraint("lowerarm_mover_offset_l", "upperarm_mover_offset_l", aimVector = [1, 0, 0], upVector = [0, 0, 1], wut = "scene", wu = [0, 0, 1])
		cmds.container(aimContainer, edit = True, addNode= constraint)
	else:
	    constraint = cmds.aimConstraint("lowerarm_mover_offset_l", "upperarm_mover_offset_l", aimVector = [1, 0, 0], upVector = [0, 0, 1], wut = "scene", wu = [0, 0, 1])
	    cmds.container(aimContainer, edit = True, addNode= constraint)	    
	...
	if cmds.objExists("lowerarm_mover_offset_l.pinned"):
		...
		constraint = cmds.aimConstraint("hand_mover_offset_l", "lowerarm_mover_offset_l", aimVector = [1, 0, 0], upVector = [0, 0, 1], wut = "scene", wu = [0, 0, 1])
		cmds.container(aimContainer, edit = True, addNode= constraint)
	else:
	    constraint = cmds.aimConstraint("hand_mover_offset_l", "lowerarm_mover_offset_l", aimVector = [1, 0, 0], upVector = [0, 0, 1], wut = "scene", wu = [0, 0, 1])
	    cmds.container(aimContainer, edit = True, addNode= constraint)	    
	...
	if cmds.objExists("upperarm_mover_offset_r.pinned"):
		...
		constraint = cmds.aimConstraint("lowerarm_mover_offset_r", "upperarm_mover_offset_r", aimVector = [-1, 0, 0], upVector = [0, 0, -1], wut = "scene", wu = [0, 0, 1])
		cmds.container(aimContainer, edit = True, addNode= constraint)
	else:
	    constraint = cmds.aimConstraint("lowerarm_mover_offset_r", "upperarm_mover_offset_r", aimVector = [-1, 0, 0], upVector = [0, 0, -1], wut = "scene", wu = [0, 0, 1])
	    cmds.container(aimContainer, edit = True, addNode= constraint)	    
	...
	if cmds.objExists("lowerarm_mover_offset_r.pinned"):
		...
		constraint = cmds.aimConstraint("hand_mover_offset_r", "lowerarm_mover_offset_r", aimVector = [-1, 0, 0], upVector = [0, 0, -1], wut = "scene", wu = [0, 0, 1])
		cmds.container(aimContainer, edit = True, addNode= constraint)
	else:
	    constraint = cmds.aimConstraint("hand_mover_offset_r", "lowerarm_mover_offset_r", aimVector = [-1, 0, 0], upVector = [0, 0, -1], wut = "scene", wu = [0, 0, 1])
	    cmds.container(aimContainer, edit = True, addNode= constraint)	    
	...
	if cmds.objExists("thigh_mover_offset_l.pinned"):
		...
		constraint = cmds.aimConstraint("calf_mover_offset_l", "thigh_mover_offset_l", aimVector = [-1, 0, 0], upVector = [1, 0, 0], wut = "scene", wu = [0, 0, 1])
		cmds.container(aimContainer, edit = True, addNode= constraint)
	else:
	    constraint = cmds.aimConstraint("calf_mover_offset_l", "thigh_mover_offset_l", aimVector = [-1, 0, 0], upVector = [1, 0, 0], wut = "scene", wu = [0, 0, 1])
	    cmds.container(aimContainer, edit = True, addNode= constraint)	    
	...
	if cmds.objExists("calf_mover_offset_l.pinned"):
		...
		constraint = cmds.aimConstraint("foot_mover_offset_l", "calf_mover_offset_l", aimVector = [-1, 0, 0], upVector = [1, 0, 0], wut = "scene", wu = [0, 0, 1])
		cmds.container(aimContainer, edit = True, addNode= constraint)	
	else:
	    constraint = cmds.aimConstraint("foot_mover_offset_l", "calf_mover_offset_l", aimVector = [-1, 0, 0], upVector = [1, 0, 0], wut = "scene", wu = [0, 0, 1])
	    cmds.container(aimContainer, edit = True, addNode= constraint)		    
	...
	if cmds.objExists("thigh_mover_offset_r.pinned"):
		...
		constraint = cmds.aimConstraint("calf_mover_offset_r", "thigh_mover_offset_r", aimVector = [1, 0, 0], upVector = [-1, 0, 0], wut = "scene", wu = [0, 0, 1])
		cmds.container(aimContainer, edit = True, addNode= constraint)
	else:
	    constraint = cmds.aimConstraint("calf_mover_offset_r", "thigh_mover_offset_r", aimVector = [1, 0, 0], upVector = [-1, 0, 0], wut = "scene", wu = [0, 0, 1])
	    cmds.container(aimContainer, edit = True, addNode= constraint)	    
	...
	if cmds.objExists("calf_mover_offset_r.pinned"):
		...
		constraint = cmds.aimConstraint("foot_mover_offset_r", "calf_mover_offset_r", aimVector = [1, 0, 0], upVector = [-1, 0, 0], wut = "scene", wu = [0, 0, 1])
		cmds.container(aimContainer, edit = True, addNode= constraint)
	else:
	    constraint = cmds.aimConstraint("foot_mover_offset_r", "calf_mover_offset_r", aimVector = [1, 0, 0], upVector = [-1, 0, 0], wut = "scene", wu = [0, 0, 1])
	    cmds.container(aimContainer, edit = True, addNode= constraint)	    
