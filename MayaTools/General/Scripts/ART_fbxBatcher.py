...
class FBX_Batcher():
	...
	self.widgets["window"] = cmds.window("ART_RetargetTool_UI", title = "ART FBX Export Batcher", w = 400, h = 400, sizeable = True, mnb = False, mxb = False)
	...
	self.widgets["removeRoot"] = cmds.checkBox(label = "Remove root animation?", v = True, parent = self.widgets["layout"])
