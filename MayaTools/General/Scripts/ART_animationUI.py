...
class AnimationUI():
	...
	self.widgets["cbFormLayout"] = cmds.formLayout("ART_cbFormLayout", w = 200, h = 700, parent = self.widgets["rowColLayout"])
        ...
        self.scriptJob = cmds.scriptJob(parent = self.widgets["window"], event = ["SelectionChanged", self.selectionScriptJob])
	...
	#setup the scriptJob
	cmds.scriptJob(event = ["readingFile", self.killUIScriptJob], runOnce = True)
	...
	cmds.connectControl(self.widgets[name + "_rightIkKneePickerButton"] , name + ":ik_foot_anim_r.knee_twist")
        ...
        if leftArmTwist > 0:
            ...
            cmds.formLayout(layout, edit = True, af = [(self.widgets[name + "_leftArmRollPickerButton"], "top", 75), (self.widgets[name + "_leftArmRollPickerButton"], "right", 96)])
	...
	if leftArmTwist > 1:
            ...
            cmds.formLayout(layout, edit = True, af = [(self.widgets[name + "_leftArmRoll2PickerButton"], "top", 75), (self.widgets[name + "_leftArmRoll2PickerButton"], "right", 76)])
	...
	if leftArmTwist > 2:
            ...
            cmds.formLayout(layout, edit = True, af = [(self.widgets[name + "_leftArmRoll3PickerButton"], "top", 75), (self.widgets[name + "_leftArmRoll3PickerButton"], "right", 56)])
        ...
        if rightArmTwist > 0:
            ...
            cmds.formLayout(layout, edit = True, af = [(self.widgets[name + "_rightArmRollPickerButton"], "top", 75), (self.widgets[name + "_rightArmRollPickerButton"], "left", 96)])
        ...
        if rightArmTwist > 1:
            ...
            cmds.formLayout(layout, edit = True, af = [(self.widgets[name + "_rightArmRoll2PickerButton"], "top", 75), (self.widgets[name + "_rightArmRoll2PickerButton"], "left", 76)])
        ...
        if rightArmTwist > 2:
            ...
            cmds.formLayout(layout, edit = True, af = [(self.widgets[name + "_rightArmRoll3PickerButton"], "top", 75), (self.widgets[name + "_rightArmRoll3PickerButton"], "left", 56)])
        ...
        if leftArmForeTwist > 1:
            self.widgets[name + "_leftForeTwist2PickerButton"] = cmds.button(w = 15, h = 15, label = "", parent = layout, bgc = self.purple, c = partial(self.buttonSelectCommand, name, "lowerarm_l_twist_2_anim"))
        ...
        if leftArmForeTwist > 2:
            self.widgets[name + "_leftForeTwist3PickerButton"] = cmds.button(w = 15, h = 15, label = "", parent = layout, bgc = self.purple, c = partial(self.buttonSelectCommand, name, "lowerarm_l_twist_3_anim"))
        ...
        if rightArmForeTwist > 1:
            self.widgets[name + "_rightForeTwist2PickerButton"] = cmds.button(w = 15, h = 15, label = "", parent = layout, bgc = self.purple, c = partial(self.buttonSelectCommand, name, "lowerarm_r_twist_2_anim"))
        ...
        if rightArmForeTwist > 2:
            self.widgets[name + "_rightForeTwist3PickerButton"] = cmds.button(w = 15, h = 15, label = "", parent = layout, bgc = self.purple, c = partial(self.buttonSelectCommand, name, "lowerarm_r_twist_3_anim"))
        ...
        #thigh twists
        if leftThighTwist > 0:
            self.widgets[name + "_leftThighTwistPickerButton"] = cmds.button(w = 15, h = 15, label = "", parent = layout, bgc = self.purple, c = partial(self.buttonSelectCommand, name, "thigh_l_twist_anim"))
        ...
        if leftThighTwist > 1:
            self.widgets[name + "_leftThighTwist2PickerButton"] = cmds.button(w = 15, h = 15, label = "", parent = layout, bgc = self.purple, c = partial(self.buttonSelectCommand, name, "thigh_l_twist_2_anim"))
        ...
        if leftThighTwist > 2:
            self.widgets[name + "_leftThighTwist3PickerButton"] = cmds.button(w = 15, h = 15, label = "", parent = layout, bgc = self.purple, c = partial(self.buttonSelectCommand, name, "thigh_l_twist_3_anim"))
        ...
        if rightThighTwist > 0:
            self.widgets[name + "_rightThighTwistPickerButton"] = cmds.button(w = 15, h = 15, label = "", parent = layout, bgc = self.purple, c = partial(self.buttonSelectCommand, name, "thigh_r_twist_anim"))
        ...
        if rightThighTwist > 1:
            self.widgets[name + "_rightThighTwist2PickerButton"] = cmds.button(w = 15, h = 15, label = "", parent = layout, bgc = self.purple, c = partial(self.buttonSelectCommand, name, "thigh_r_twist_2_anim"))
        ...
        if rightThighTwist > 2:
            self.widgets[name + "_rightThighTwist3PickerButton"] = cmds.button(w = 15, h = 15, label = "", parent = layout, bgc = self.purple, c = partial(self.buttonSelectCommand, name, "thigh_r_twist_3_anim"))
   ...
   # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # 
    ...
    def listView_ScriptJob(self, *args):
        ...
        self.widgets["listViewScriptJob"] = cmds.scriptJob(event = ["SelectionChanged", self.listView_scriptJobCommand], parent = self.widgets["window"], runOnce = True)
	...
	for item in selection:
		...
		if niceName not in selectedItems:
		    print "something not in selectedItems in listView"
    ...
    def toggleControlVis(self, visibility, *args):
        ...
        for control in ["head_fk_anim", "neck_01_fk_anim", "neck_02_fk_anim", "neck_03_fk_anim", "spine_01_anim", "spine_02_anim", "spine_03_anim", "spine_04_anim", "spine_05_anim", "mid_ik_anim", "chest_ik_anim",
                        "body_anim", "hip_anim", "clavicle_l_anim", "clavicle_r_anim", "fk_arm_l_anim", "fk_arm_r_anim", "fk_elbow_l_anim", "fk_elbow_r_anim", "fk_wrist_l_anim", "fk_wrist_r_anim",
                        "ik_elbow_l_anim", "ik_elbow_r_anim", "ik_wrist_l_anim", "ik_wrist_r_anim", "fk_thigh_l_anim", "fk_thigh_r_anim", "fk_calf_l_anim", "fk_calf_r_anim", "fk_foot_l_anim", "fk_foot_r_anim",
                        "fk_ball_l_anim", "fk_ball_r_anim","ik_knee_anim_l", "ik_knee_anim_r", "ik_foot_anim_l", "ik_foot_anim_r", "heel_ctrl_l", "heel_ctrl_r", "toe_wiggle_ctrl_l", "toe_wiggle_ctrl_r",
                        ...
                        "index_l_ik_anim", "index_r_ik_anim", "middle_l_ik_anim", "middle_r_ik_anim", "ring_l_ik_anim", "ring_r_ik_anim", "pinky_l_ik_anim", "pinky_r_ik_anim", "thumb_l_ik_anim", "thumb_r_ik_anim",
                        "index_l_poleVector", "index_r_poleVector", "middle_l_poleVector", "middle_r_poleVector", "ring_l_poleVector", "ring_r_poleVector", "pinky_l_poleVector", "pinky_r_poleVector", "thumb_l_poleVector", "thumb_r_poleVector",
                        "l_global_ik_anim", "r_global_ik_anim"]:
	    controls.append(control)
    ...
    def updateUI_scriptJob(self, *args):
        self.mainScriptJob = cmds.scriptJob(event = ["timeChanged", self.updateUI], parent = self.widgets["window"])
    ...
    def setupButtonAttrsOnControls(self):
	    ...
	    try:
		if cmds.objExists(character + ":" + "thigh_l_twist_anim"):
		    if cmds.objExists(character + ":" + "thigh_l_twist_anim.buttonName"):
			cmds.setAttr(character + ":" + "thigh_l_twist_anim.buttonName",self.widgets[character + "_leftThighTwistPickerButton"], type = "string")
			
		    else:
			cmds.select(character + ":" + "thigh_l_twist_anim")
			cmds.addAttr(ln = "buttonName", dt = "string", keyable = False)
			cmds.setAttr(character + ":" + "thigh_l_twist_anim.buttonName",self.widgets[character + "_leftThighTwistPickerButton"], type = "string")
	    except:
		pass
	    ...
	    try:
		if cmds.objExists(character + ":" + "thigh_r_twist_anim"):
		    if cmds.objExists(character + ":" + "thigh_r_twist_anim.buttonName"):
			cmds.setAttr(character + ":" + "thigh_r_twist_anim.buttonName",self.widgets[character + "_rightThighTwistPickerButton"], type = "string")
			
		    else:
			cmds.select(character + ":" + "thigh_r_twist_anim")
			cmds.addAttr(ln = "buttonName", dt = "string", keyable = False)
			cmds.setAttr(character + ":" + "thigh_r_twist_anim.buttonName",self.widgets[character + "_rightThighTwistPickerButton"], type = "string")
	    except:
		pass
