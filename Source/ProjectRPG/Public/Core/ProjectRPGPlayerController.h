...
public:
    ...
    UFUNCTION(reliable, client, WithValidation, BlueprintCallable, meta = (FriendlyName = "Toggle Quest", CompactNodeTitle = "TglQst", Keywords = "Toggle Quest"), Category = HUD)
        void ToggleQuestGiveMode();
